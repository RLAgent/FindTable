...
/** A helper class for SettingsFragment that provides easy access to variable
 *  values, such as the total number of table types or the current count, total
 *  count, type, or size of a specified table. It also provides functions for
 *  saving counts and settings in the persistent application data.
 * 
 * @author lilee
 *
 */
