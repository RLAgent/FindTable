...
public class POST {
	...
	public POST(MainActivity mainActivityReference) {
		threadFlag = false;
		DELAY = 1000;
	...
	private void POSTrequest() {
		...
		try {
			...
			if (s.equals("Logged out!"))
			{
				POST.unsetFlag();
				this.timer.cancel();
				// TODO: Add code for logging back in!!
				Intent loginIntent = new Intent(mainActivityReference, LoginActivity.class);
				mainActivityReference.startActivity(loginIntent);
